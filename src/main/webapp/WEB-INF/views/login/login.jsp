...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/statics/matrixAdmin/assets/images/favicon.png">
    <title>Matrix Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="/statics/matrixAdmin/dist/css/style.min.css" rel="stylesheet">
...
<body>
    ...
    <!-- All Required js -->
    <!-- ============================================================== -->
    <script src="/statics/matrixAdmin/assets/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="/statics/matrixAdmin/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="/statics/matrixAdmin/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugin js -->
    <!-- ============================================================== -->
    <script>
