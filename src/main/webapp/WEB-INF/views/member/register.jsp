...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/statics/matrix-admin-bt4/assets/images/favicon.png">
    <title>Matrix Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="/statics/matrix-admin-bt4/dist/css/style.min.css" rel="stylesheet">
...
<body>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div>
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="/statics/matrix-admin-bt4/assets/images/logo.png" alt="logo" /></span>
                    </div>
                    <!-- Form -->
    ...
    <!-- All Required js -->
    <!-- ============================================================== -->
    <script src="/statics/matrix-admin-bt4/assets/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="/statics/matrix-admin-bt4/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="/statics/matrix-admin-bt4/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugin js -->
    <!-- ============================================================== -->
    <script>
